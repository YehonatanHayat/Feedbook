...
function People(){
  ...
  <li class="list-group-item d-flex align-items-center">
  <img src={nick} alt="Circular Image" class="circular-image"/>
...
<span class="w-10 m-4"> Gabi Li</span>
  ...
  <li class="list-group-item d-flex align-items-center">
  <img src={tim} alt="Circular Image" class="circular-image"/>
  <span class="w-10 m-4"> Tim Brown</span>
    
  
  </li>
  <li class="list-group-item d-flex align-items-center">
  <img src={matt} alt="Circular Image" class="circular-image"/>
